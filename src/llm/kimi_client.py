...
from .kimi_models import get_model_context_length
...
class KimiClient(LLMClientBase):
    ...
    def __init__(
        ...
        # logger.info(f"Kimi客户端已初始化 - 模型: {model_name}, API基础URL: {self.api_base}")
    ...
    def call(self, prompt: str, **kwargs) -> str:
        ...
        for attempt in range(max_retries):
            try:
                ...
                # logger.warning(f"Kimi原始响应: {result}")
    ...
    @classmethod
    def from_env(cls, **kwargs) -> "KimiClient":
        """
        从环境变量创建Kimi客户端
        ...
        model_env = os.getenv("KIMI_MODEL")
